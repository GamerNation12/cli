...
function Get-Spicetify {
  ...
  begin {
    ...
    if ($v) {
      ...
      # Restored to official Spicetify API to find the actual files
  ...
  process {
    ...
    $Parameters = @{
      # Restored to official Spicetify download link
...
if ($choice -eq 1) {
  ...
  $Parameters = @{
    # Keeps your custom GamerNation12 Marketplace link
